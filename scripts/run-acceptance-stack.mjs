...
const commonEnvironment = {
  ...
  DATABASE_URL: localEnvironment.DATABASE_URL ?? 'postgresql://tellann:password@127.0.0.1:5433/tellann?schema=public',
  JWT_SECRET: localEnvironment.JWT_SECRET ?? 'tellann-default-jwt-secret-change-in-production',
